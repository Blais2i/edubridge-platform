      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <header className="flex items-center justify-between mb-12">
          ...
          <nav className="flex items-center gap-3">
            <Link
              href="/login"
              className="px-4 py-2 rounded-md border border-transparent hover:border-cyan-300"
            >
              Login
            </Link>
            <Link
              href="/register"
              className="px-4 py-2 rounded-md bg-cyan-500 text-white shadow-sm hover:brightness-95"
            >
              Register
            </Link>
          </nav>
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="flex gap-3">
              <Link
                href="/register"
                className="inline-block px-6 py-3 rounded-md bg-cyan-500 text-white shadow-sm hover:brightness-95"
              >
                Create account
              </Link>
            </div>
